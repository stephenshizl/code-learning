...
ifeq ($(BOARD_HAVE_ORI),qmc6308)
include $(CLEAR_VARS)
LOCAL_SRC_FILES		:= mag/libical_qmc6308_32.a
LOCAL_MODULE 		:= libical_qmc6308_32
LOCAL_MULTILIB		:= 32
...
include $(CLEAR_VARS)
LOCAL_SRC_FILES		:= mag/libical_qmc6308_64.a
LOCAL_MODULE 		:= libical_qmc6308_64
LOCAL_MULTILIB		:= 64
LOCAL_MODULE_CLASS 	:= STATIC_LIBRARIES
LOCAL_MODULE_SUFFIX	:= .a
LOCAL_MODULE_TAGS 	:= optional
...
LOCAL_STATIC_LIBRARIES_32 += libical_qmc6308_32
LOCAL_STATIC_LIBRARIES_64 += libical_qmc6308_64
else
...
#################################################################
#GYROSCOPE
ifeq ($(BOARD_HAVE_GYRO),qmi8610)
LOCAL_SRC_FILES += gyro/Gyro_$(BOARD_HAVE_GYRO).cpp
